...
export default async function OptionCopyTradingPage() {
  const t = await getTranslations("optionCopyTradingPage");
  ...
  const cons = [
    { head: t("con1Head"), body: t("con1Body") },
    { head: t("con2Head"), body: t("con2Body") },
  ];
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <FadeUp>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-8">{t("riskHead")}</h2>
